# mana-tuapapa-selection: mana-tuapapa-selection-excellence
# Authors: Amy Marshall, Jason Gush
# Revised from whitinga-selection-excellence.r
# mana-tuapapa-selection-excellence.r 2024-05-20 13:28

#threshold to be determined by the panel 
mana_tuapapa_selection_excellence <- function(dataframe, ma = 4, pa = 2, ff = 10, fe = 20, threshold = 3.5){
